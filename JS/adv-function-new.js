...
function advInitMetricDropdown(metrics, labelsMap) {
  // Do not rebuild dropdown items, just ensure the label text matches the default metric.
  ...
  document.querySelectorAll(".chart-metric-dd-select").forEach(function (wrapper) {
    ...
    var displayText = (labelsMap && labelsMap[defaultMetric]) ? labelsMap[defaultMetric] : defaultMetric;
